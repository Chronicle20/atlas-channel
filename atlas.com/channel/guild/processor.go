...
func (p *Processor) RequestCreate(m _map.Model, characterId uint32, name string) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(requestCreateProvider(m, characterId, name))
}
...
func (p *Processor) CreationAgreement(characterId uint32, agreed bool) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(creationAgreementProvider(characterId, agreed))
}
...
func (p *Processor) RequestEmblemUpdate(guildId uint32, characterId uint32, logoBackground uint16, logoBackgroundColor byte, logo uint16, logoColor byte) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(changeEmblemProvider(guildId, characterId, logo, logoColor, logoBackground, logoBackgroundColor))
}
...
func (p *Processor) RequestNoticeUpdate(guildId uint32, characterId uint32, notice string) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(changeNoticeProvider(guildId, characterId, notice))
}
...
func (p *Processor) Leave(guildId uint32, characterId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(leaveGuildProvider(guildId, characterId))
}
...
func (p *Processor) Expel(guildId uint32, characterId uint32, targetId uint32, targetName string) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(expelGuildProvider(guildId, targetId))
}
...
func (p *Processor) RequestInvite(guildId uint32, characterId uint32, targetId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(requestInviteProvider(guildId, characterId, targetId))
}
...
func (p *Processor) RequestTitleChanges(guildId uint32, characterId uint32, titles []string) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(changeTitlesProvider(guildId, characterId, titles))
}
...
func (p *Processor) RequestMemberTitleUpdate(guildId uint32, characterId uint32, targetId uint32, newTitle byte) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(changeMemberTitleProvider(guildId, characterId, targetId, newTitle))
}
