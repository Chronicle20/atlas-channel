...
func (p *Processor) ModifyThread(guildId uint32, characterId uint32, threadId uint32, notice bool, title string, message string, emoticonId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(updateCommandProvider(guildId, characterId, threadId, notice, title, message, emoticonId))
}
...
func (p *Processor) CreateThread(guildId uint32, characterId uint32, notice bool, title string, message string, emoticonId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(createCommandProvider(guildId, characterId, notice, title, message, emoticonId))
}
...
func (p *Processor) DeleteThread(guildId uint32, characterId uint32, threadId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(deleteCommandProvider(guildId, characterId, threadId))
}
...
func (p *Processor) ReplyToThread(guildId uint32, characterId uint32, threadId uint32, message string) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(addReplyCommandProvider(guildId, characterId, threadId, message))
}
...
func (p *Processor) DeleteReply(guildId uint32, characterId uint32, threadId uint32, replyId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(EnvCommandTopic)(deleteReplyCommandProvider(guildId, characterId, threadId, replyId))
}
