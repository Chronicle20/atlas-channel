...
import (
	...
	thread3 "atlas-channel/kafka/producer/guild/thread"
	"context"
...
func (p *Processor) ModifyThread(guildId uint32, characterId uint32, threadId uint32, notice bool, title string, message string, emoticonId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(thread2.EnvCommandTopic)(thread3.UpdateCommandProvider(guildId, characterId, threadId, notice, title, message, emoticonId))
}
...
func (p *Processor) CreateThread(guildId uint32, characterId uint32, notice bool, title string, message string, emoticonId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(thread2.EnvCommandTopic)(thread3.CreateCommandProvider(guildId, characterId, notice, title, message, emoticonId))
}
...
func (p *Processor) DeleteThread(guildId uint32, characterId uint32, threadId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(thread2.EnvCommandTopic)(thread3.DeleteCommandProvider(guildId, characterId, threadId))
}
...
func (p *Processor) ReplyToThread(guildId uint32, characterId uint32, threadId uint32, message string) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(thread2.EnvCommandTopic)(thread3.AddReplyCommandProvider(guildId, characterId, threadId, message))
}
...
func (p *Processor) DeleteReply(guildId uint32, characterId uint32, threadId uint32, replyId uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(thread2.EnvCommandTopic)(thread3.DeleteReplyCommandProvider(guildId, characterId, threadId, replyId))
}
