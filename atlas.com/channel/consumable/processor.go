...
func (p *Processor) RequestItemConsume(characterId uint32, itemId uint32, slot int16, updateTime uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(consumable2.EnvCommandTopic)(RequestItemConsumeCommandProvider(characterId, slot, itemId, 1))
}
...
func (p *Processor) RequestScrollUse(characterId uint32, scrollSlot int16, equipSlot int16, whiteScroll bool, legendarySpirit bool, updateTime uint32) error {
	...
	return producer.ProviderImpl(p.l)(p.ctx)(consumable2.EnvCommandTopic)(RequestScrollCommandProvider(characterId, scrollSlot, equipSlot, whiteScroll, legendarySpirit))
}
